...
def browse_listings():
    ...
    query = Donation.query.filter_by(status=DonationStatus.APPROVED)
...
def view_listing(listing_id):
    ...
    return render_template('ngo/view_listing.html', donation=donation, donor=donor, existing_request=existing_request)
